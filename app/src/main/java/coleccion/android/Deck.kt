...
class Deck : Stack<Card>() {
    ...
    val bPE1 = Card("Blue", 1, "Parallelogram", "Empty", R.drawable.colecci_n_blue_parallelogram_e_1)
    val bPE2 = Card("Blue", 2, "Parallelogram", "Empty", R.drawable.colecci_n_blue_parallelogram_e_2)
    val bPE3 = Card("Blue", 3, "Parallelogram", "Empty", R.drawable.colecci_n_blue_parallelogram_e_3)
    ...
    val gPE1 = Card("Green", 1, "Parallelogram", "Empty", R.drawable.colecci_n_green_parallelogram_e_1)
    val gPE2 = Card("Green", 2, "Parallelogram", "Empty", R.drawable.colecci_n_green_parallelogram_e_2)
    val gPE3 = Card("Green", 3, "Parallelogram", "Empty", R.drawable.colecci_n_green_parallelogram_e_3)
    val gPS1 = Card("Green", 1, "Parallelogram", "Grid", R.drawable.colecci_n_green_parallelogram_s_1)
    val gPS2 = Card("Green", 2, "Parallelogram", "Grid", R.drawable.colecci_n_green_parallelogram_s_2)
    val gPS3 = Card("Green", 3, "Parallelogram", "Grid", R.drawable.colecci_n_green_parallelogram_s_3)
    val oP1 = Card("Orange", 1, "Parallelogram", "Solid", R.drawable.colecci_n_orange_parallelogram_1)
    val oP2 = Card("Orange", 2, "Parallelogram", "Solid", R.drawable.colecci_n_orange_parallelogram_2)
    val oP3 = Card("Orange", 3, "Parallelogram", "Solid", R.drawable.colecci_n_orange_parallelogram_3)
    val oPE1 = Card("Orange", 1, "Parallelogram", "Empty", R.drawable.colecci_n_orange_parallelogram_e_1)
    val oPE2 = Card("Orange", 2, "Parallelogram", "Empty", R.drawable.colecci_n_orange_parallelogram_e_2)
    val oPE3 = Card("Orange", 3, "Parallelogram", "Empty", R.drawable.colecci_n_orange_parallelogram_e_3)
    val oPS1 = Card("Orange", 1, "Parallelogram", "Grid", R.drawable.colecci_n_orange_parallelogram_s_1)
    val oPS2 = Card("Orange", 2, "Parallelogram", "Grid", R.drawable.colecci_n_orange_parallelogram_s_2)
    val oPS3 = Card("Orange", 3, "Parallelogram", "Grid", R.drawable.colecci_n_orange_parallelogram_s_3)
